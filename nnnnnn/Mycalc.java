...
public class Mycalc {
    ...
    public static void main(String args[]){
        ...
        String t="0.000005+0.000000078";
        String input="g+6g/-56-345g-9g";
       String[] res=getTerms(input,"g");
        int i=5;
        String var="g";
        //String[] vars=coefficientresolution(res ,"g");
        System.out.println(constantsresolution(input,"g"));
